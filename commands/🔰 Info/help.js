...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    if (args[0]) {
     ...
     let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("840260133686870036").setLabel("Random Video").setURL("https://youtu.be/dQw4w9WgXcQ")
      let menuOptions = [{
          label: "Overview",
          value: "Overview",
...
📶 **\`${Math.floor(client.ws.ping)}ms\` Ping**
 Made by [**GwB Community \\ Mr GwB 3604**](https://discord.gg/YjjPFbcwMn)`)
